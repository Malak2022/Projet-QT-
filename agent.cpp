     ...
     ui(new Ui::agent)
{
    ui->setupUi(this);
      ...
      ui->comboBox_suppression->setModel(e.afficher());
     ...
     ui->lineEdit_type->setValidator(new QRegExpValidator(QRegExp("[A-Z,a-z]*")));
      ...
      ui->label_picc_2->setPixmap(pix.scaled(100,100,Qt::KeepAspectRatio));
      ui->label_piccl_2->setPixmap(pixxx.scaled(100,100,Qt::KeepAspectRatio));
...
void agent::on_pushButton_suppression_clicked()
{
    {
...
void agent::on_pushButton_modifier_clicked()
...
void agent::on_comboBox_2_currentIndexChanged(const QString &arg1)
{
...
void agent::on_comboBox_suppression_currentIndexChanged(const QString &arg1)
{
    QMediaPlayer *music=new QMediaPlayer();
    music->setMedia(QUrl("C:/Users/Nawres/Downloads/mixkit-fast-double-click-on-mouse-275.wav"));
    music->setVolume(5);
    music->play();
    int numero =ui->comboBox_suppression->currentText().toInt();
         QString num= QString::number(numero);
                QSqlQuery query;
                query.prepare("select * from evenement where NUMERO='"+num+"'");
...
void agent::on_pushButton_recherche_clicked()
{
    QMediaPlayer *music=new QMediaPlayer();
    music->setMedia(QUrl("C:/Users/Nawres/Downloads/mixkit-fast-double-click-on-mouse-275.wav"));
    music->setVolume(5);
...
void agent::on_pushButton_tri_clicked()
{
    QMediaPlayer *music=new QMediaPlayer();
    music->setMedia(QUrl("C:/Users/Nawres/Downloads/mixkit-fast-double-click-on-mouse-275.wav"));
    music->setVolume(5);
...
void agent::on_pushButton_5_clicked()
{
...
void agent::on_pushButton_stat_clicked()
{
    QMediaPlayer *music=new QMediaPlayer();
    music->setMedia(QUrl("C:/Users/Nawres/Downloads/mixkit-fast-double-click-on-mouse-275.wav"));
    music->setVolume(5);
...
void agent::on_calendarWidget_2_clicked(const QDate &date)
{
    ...
    music->play();
       ui->dateEdit_date = new QDateEdit;
                      ...
                      //QString date=ui->currentdate->toString();
                       ...
                       if (model != nullptr)
                       {
                          ui->tcalendrier_2->setModel(model);
                       }

    }


void agent::on_reduction_clicked()
{
...
void agent::on_pushButton_6_clicked()
{
    QMediaPlayer *music=new QMediaPlayer();
    music->setMedia(QUrl("C:/Users/Nawres/Downloads/mixkit-fast-double-click-on-mouse-275.wav"));
    music->setVolume(5);
