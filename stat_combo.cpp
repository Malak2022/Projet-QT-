...
q2.prepare("SELECT * FROM PERSONNEL WHERE GENRE='1'");
q2.exec();

q3.prepare("SELECT * FROM PERSONNEL WHERE GENRE='2'");
q3.exec();

q4.prepare("SELECT * FROM PERSONNEL WHERE GENRE='3' ");
q4.exec();
...
//pie chart
    ...
    // Define slices and the percentage of whole they take up
    QPieSeries *series = new QPieSeries();
    series->append("1000",c1);
    series->append("1500",c2);
